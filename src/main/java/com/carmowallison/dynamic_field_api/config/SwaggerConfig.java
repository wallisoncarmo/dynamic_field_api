...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.carmowallison.dynamic_field_api.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Formuláros Dinâmicos",
				"Api que gera formularios dinamicos.", "Versão 1.0",
				"https://github.com/wallisoncarmo/dynamic_field_api",
				new Contact("Wallison do Carmo Costa", "https://github.com/wallisoncarmo/dynamic_field_api", "wallisoncarmo01@gmail.com"),
				null, 
